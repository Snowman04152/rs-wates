                        ...
                        @foreach ($pemeliharaan as $datas)
                            ...
                            <td>
                                <div class="d-flex justify-content-center ">
                                    ...
                                    <form id="nested-form"
                                        action="{{ route('pemeliharaanuser.delete', ['id' => $datas->id]) }}" method="POST">
                                        @csrf
                                        @method('delete')
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('pemeliharaanuser.add') }}">
                        @csrf
                        <div>
                            <div>
                                <label for="namaAlat" class="form-label">Pilih Alat Medis :</label>
    ...
    <script type="module">
        document.addEventListener('click', function(event) {
            if (event.target.matches('.edit-periksa')) {
                ...
                editPeriksaForm.action = '/dataperiksauser/edit/' + periksaId;
