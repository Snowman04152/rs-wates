                        ...
                        <td>
                            <div class="d-flex justify-content-center ">
                                <button type="button" data-bs-toggle='modal' data-id_alat="{{ $data->id }}"
                                    ...
                                    <form id="nested-form" action="{{ route('datauser.delete', ['id' => $data->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('delete')
...
<div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('datauser.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <div>
                            <label for="namaAlat" class="form-label">Nama Alat Medis :</label>
...
<script type="module">
    document.addEventListener('click', function(event) {
        if (event.target.matches('.edit-alat-medis')) {
            ...
            editAlatForm.action = '/dataalatuser/edit/' + alatId;
