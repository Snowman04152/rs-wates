<nav id="sidebar">
    ...
    <ul class="list-unstyled components fs-5">
        <li>
            <a href="{{ route('dashboardkepalaruang') }}"> <i class="bi bi-house "></i> Halaman Utama </a>
        </li>
        <li>
            <a href="{{route('data_periksa_kepalaruang')}}"> <i class="bi bi-file-earmark-text"></i> Jadwal Pemeliharaan </a>
        </li>
